...
/* Generated by Opal 0.5.5 */
(function($opal) {
  var $a, $b, TMP_1, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $range = $opal.range, $klass = $opal.klass, t = nil;
  $opal.add_stubs(['$puts', '$each', '$==', '$new', '$is_me?']);
  ;
  self.$puts("Hello Renée!");
  ($a = ($b = ($range(1, 5, false))).$each, $a._p = (TMP_1 = function(a){var self = TMP_1._s || this;if (a == null) a = nil;
  return self.$puts(a)}, TMP_1._s = self, TMP_1), $a).call($b);
  (function($base, $super) {
    function $Test(){};
    var self = $Test = $klass($base, $super, 'Test', $Test);

    var def = $Test._proto, $scope = $Test._scope;
    def.name = nil;
    ...
    return (def['$is_me?'] = function() {
      var self = this;
      return self.name['$==']("Adam");
    }, nil);
  })(self, null);
  t = (($a = $scope.Test) == null ? $opal.cm('Test') : $a).$new("Adam");
  return self.$puts((($a = $scope.Test) == null ? $opal.cm('Test') : $a)['$is_me?']());
})(Opal);
